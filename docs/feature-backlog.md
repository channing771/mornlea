...
| A-03 | 三级剑与统一战斗 | 木/石/铁剑（4/5/6 伤害）、统一候选（≤72）与冷却/击退/耐久、CombatHit 私有确认 | 就绪 | — | 原分支头 `42f3dead`（SPEC/QUALITY PASS）未推送远端已丢失；recipe 15..17 依赖 A-01 合流；依赖 A-02；版本和编号不再由 A-06 预分配 |
