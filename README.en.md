...
- Mining and block-break drops become pickable after `10` active ticks, while actively discarded and death drops become pickable after `40` active ticks; once that source-specific delay ends, players within 1.25 blocks can pick them up. Drops expire after 6000 active ticks, and only drops near players (chunk radius 2) advance their lifetime;
