...
//! (版本见 `mornlea_client_abi_version`,当前 v9,与 `mornlea_engine` ABI
//! 互不耦合)供 Go `internal/client` 调用。client ABI v9 在 v8 的 egui 菜单
//! 出口与帧 TLV tag 9 上增加设置 layout v2 和结构化事件 batch。控制权保持在 Go 主线程:每帧一次
