//! Foundation registration and dependency-direction contracts for `mornlea_protocol`.
//! Packet-family ports remain recorded in the change ledger until each family
