...
/// Fixed wire stride of one equip-armor payload: the 8-byte sequence alone,
/// with no target armor slot or item field.
const EQUIP_ARMOR_WIRE_BYTES: usize = 8;
