...
/// Fixed wire stride of one till soil payload: the 8-byte sequence and the two
/// look angles.
const TILL_SOIL_WIRE_BYTES: usize = 16;

/// Play TillSoil payload. The server validates that the ray-cast target is
/// a fluid-adjacent dirt block and owns the resulting block write; the
