...
// `WORLDGEN_HEADER_BYTES` 和 packages/shared/worldgen 的同名常量一致。
...
// packages/shared/core/block.go 的 iota 实测一致:水 27、流动水 1..7 = 28..34、
...
// 与 packages/shared/core/block.go 的 iota 实测一致:空气 0、石头 2、源 27、
