...
// lifecycle, and connection exports (create, destroy, status identity, the
// ABI version accessor, connect begin/poll, and disconnect) live in
// exports.go; the remaining family exports land with their later changes.
// Until the c-shared build lands, this package also pins the ABI with the
