...
// lifecycle, connection, input, step, world, frame, and status exports
// (create, destroy, status identity, the ABI version accessor, connect
// begin/poll, disconnect, submit input, step, world pull, frame pull, and
// status pull) live in exports.go. Until the c-shared build lands, this
// package also pins the ABI with the cross-language consistency tests shared
// with the Rust consumer.
package main
