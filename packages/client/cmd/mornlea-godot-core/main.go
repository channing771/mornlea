...
// lifecycle, connection, input, and step exports (create, destroy, status
// identity, the ABI version accessor, connect begin/poll, disconnect, submit
// input, and step) live in exports.go; the remaining family exports land with
// their later changes. Until the c-shared build lands, this package also pins
// the ABI with the cross-language consistency tests shared with the Rust
// consumer.
package main
