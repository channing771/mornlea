...
// 的 `UploadSection`/`DropSection`(本包不得 import packages/client/render,只复刻
// 形状);由 packages/client/cmd/mornlea 的接线层(任务 5.2)适配到 client ABI v6 的
...
// (packages/client/cmd/mornlea 的 `LodNearTileRadius`,保证壳最小覆盖块 ≥ 近 mesh 覆盖
