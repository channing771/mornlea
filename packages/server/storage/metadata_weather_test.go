...
// TestMetadataV3MigratesToV4WithClearWeather 覆盖 Scenario「v3 世界迁移默认晴天」：
// 种子、出生信息、世界时间与偏移必须原值保留，天气迁移为晴天、剩余时长为零，
// 读入即规范为当前版本。
func TestMetadataV3MigratesToV4WithClearWeather(t *testing.T) {
	legacy := Metadata{
