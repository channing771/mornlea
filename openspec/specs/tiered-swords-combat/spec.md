...
- **AND** engine/client ABI 8/11 MUST 只表示 commit `90188fbc` 交付剑战变更时的历史基线，MUST NOT 与后续 client ABI v12 或当前 v13 混淆
