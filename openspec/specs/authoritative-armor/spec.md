# authoritative-armor Specification

## Purpose
TBD - created by archiving change authoritative-armor. Update Purpose after archive.
## Requirements
...
- **GIVEN** 胸部槽位已有另一件护甲且所选快捷栏格持有铁胸甲
- **WHEN** 发送 `EquipArmor`
- **THEN** 铁胸甲上台、原胸部槽位护甲件回到所选快捷栏格，交换在同 tick 原子完成
