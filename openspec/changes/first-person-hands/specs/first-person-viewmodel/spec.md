...
双手 cuboid 的尺寸、明暗与材质层号 SHALL 与第三人称手臂同源：臂尺寸 `0.1×0.7×0.25`、颜色为身体基色 `avatarShade(base, 0.82)`、材质为头部层 `+12` 的臂层；同 `PlayerID` 下第一人称手色与第三人称身体基色 MUST 一致。
