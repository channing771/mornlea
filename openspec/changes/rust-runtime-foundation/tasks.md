...
- [ ] 1.4 [Exclusive temporary work and atomic export](plans/01-evidence.md#node-1-4). Direct prerequisites: 1.3. Execute the linked packet's named red/green and integration commands.
