...
- [x] 1.1 失败测试先行：前端 vitest 先改（`HudRoot.test`/`hud.assert.test`
...
- [x] 1.2 实现：schema.json/client.ts/HudRoot/ProgressTrack/hud.css/
