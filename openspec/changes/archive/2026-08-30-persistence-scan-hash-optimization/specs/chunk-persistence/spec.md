# persistence-scan-hash-optimization 行为契约

本 change 新增 `chunk-persistence` 能力主规格。既有 `player-persistence`、`companion-persistence`、`hostile-mob-persistence`、`persistent-item-drops` 能力不受影响。
