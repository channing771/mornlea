...
- [ ] 5. 运行 `go test ./internal/sim -race -count=1`、`go test ./internal/archcheck -count=1`、`gofmt -l .`、`go vet ./...`、`openspec validate --all --strict --no-interactive`
- [ ] 6. 更新 `openspec/specs/authoritative-farming/spec.md` 主规格（经 `openspec sync` 或归档时直编）并回填 `docs/feature-backlog.md` B-06 → 已完成
