...
func TestContainerPixelCellsUseSharedSlotUV(t *testing.T) {
	...
	for _, view := range []struct {
		...
		t.Run(view.name, func(t *testing.T) {
			got := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, view.crafting, view.overlay, view.chest, MiningOverlay{}, width, height)
...
func TestContainerTitlesUseAtlasCells(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			var layout hotbarLayout
			got := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, test.crafting, test.overlay, test.chest, MiningOverlay{}, width, height)
...
func TestCraftingOverlayDrawsPersonalAndWorkbenchGrids(t *testing.T) {
	...
	var layout hotbarLayout
	got := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, personal, nil, nil, MiningOverlay{}, width, height)
	...
	got = layoutInventory(&layout, atlas, core.Inventory{}, true, -1, workbench, nil, nil, MiningOverlay{}, width, height)
	...
	got = layoutInventory(&layout, atlas, core.Inventory{}, true, -1, empty, nil, nil, MiningOverlay{}, width, height)
...
func TestCraftingSourceHighlightCoversUnifiedView(t *testing.T) {
	...
	for _, source := range []int{0, 4, 8, 9, 17, 44} {
		got := layoutInventory(
			...
			&CraftingOverlay{Size: 3}, nil, nil, MiningOverlay{}, 1280, 800,
		)
	...
	got := layoutInventory(
		...
		fullCraftingOverlay(), nil, nil, MiningOverlay{}, 1280, 800,
	)
...
func TestInventoryLayoutDrawsCraftingArea(t *testing.T) {
	...
	open := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, nil, nil, nil, MiningOverlay{}, 1280, 800)
	...
	got := layoutInventory(&layout, atlas, full, true, 5, workbench, nil, nil, MiningOverlay{}, 1280, 800)
...
func TestContainerOverlaysReplaceCraftingGrid(t *testing.T) {
	...
	workbench := &CraftingOverlay{Size: 3}
	crafting := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, workbench, nil, nil, MiningOverlay{}, 1280, 800)
	// 空 3×3：面板、10 个凹槽与标题。
	...
	for _, view := range []struct {
		...
		got := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, workbench, view.overlay, view.chest, MiningOverlay{}, 1280, 800)
...
func TestFurnaceOverlayDrawsThreeSlotsAndTwoBars(t *testing.T) {
	...
	empty := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, nil, &FurnaceOverlay{}, nil, MiningOverlay{}, 1280, 800)
	...
	full := layoutInventory(
		&layout, atlas, core.Inventory{}, true, -1, nil, fullFurnaceOverlay(), nil, MiningOverlay{}, 1280, 800,
	)
...
func TestFurnaceSourceHighlightCoversFurnaceSlots(t *testing.T) {
	...
	for source := range core.FurnaceViewSlots {
		got := layoutInventory(
			&layout, atlas, core.Inventory{}, true, source,
			nil, &FurnaceOverlay{}, nil, MiningOverlay{}, 1280, 800,
		)
		// 面板和当前选中框之后是来源高亮。
		highlight := got.quads[openInventoryPanelQuads+1]
...
func TestChestOverlayDraws27SlotsWithItemsAndCounts(t *testing.T) {
	...
	empty := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, nil, nil, &ChestOverlay{}, MiningOverlay{}, 1280, 800)
	...
	got := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, nil, nil, &sparse, MiningOverlay{}, 1280, 800)
	...
	full := layoutInventory(&layout, atlas, core.Inventory{}, true, -1, nil, nil, fullChestOverlay(), MiningOverlay{}, 1280, 800)
...
func TestChestOverlayTakesPriorityOverFurnaceOverlay(t *testing.T) {
	...
	both := layoutInventory(
		&layout, atlas, core.Inventory{}, true, -1, &CraftingOverlay{Size: 3}, &FurnaceOverlay{}, &ChestOverlay{}, MiningOverlay{}, 1280, 800,
	)
	chestOnly := layoutInventory(
		&layout, atlas, core.Inventory{}, true, -1, nil, nil, &ChestOverlay{}, MiningOverlay{}, 1280, 800,
	)
...
func TestChestSourceHighlightCoversChestSlots(t *testing.T) {
	...
	for source := range core.ChestViewSlots {
		got := layoutInventory(
			&layout, atlas, core.Inventory{}, true, source,
			nil, nil, &ChestOverlay{}, MiningOverlay{}, 1280, 800,
		)
		// 面板和当前选中框之后是来源高亮。
		highlight := got.quads[openInventoryPanelQuads+1]
		wantX, wantY := inventorySlotOrigin(source, true, 1280, 800)
